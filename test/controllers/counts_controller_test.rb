...
class CountsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create count" do
    assert_difference("Count.count") do
      post counts_url, params: { count: { description: @count.description, initial_amount: @count.initial_amount, name: @count.name } }
    end
  ...
  test "should update count" do
    patch count_url(@count), params: { count: { description: @count.description, initial_amount: @count.initial_amount, name: @count.name } }

...
class MovementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create movement" do
    assert_difference("Movement.count") do
      post movements_url, params: { movement: { amount: @movement.amount, causal: @movement.causal, currency_date: @movement.currency_date, expensive_item_id: @movement.expensive_items_id, movement_type: @movement.movement_type, node: @movement.node, user_id: @movement.user_id } }
    end
  ...
  test "should update movement" do
    patch movement_url(@movement), params: { movement: { amount: @movement.amount, causal: @movement.causal, currency_date: @movement.currency_date, expensive_item_id: @movement.expensive_item_id, movement_type: @movement.movement_type, node: @movement.node, user_id: @movement.user_id } }
